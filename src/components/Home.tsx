  ...
  const featureCards = [
    {
      ...
      description: "Discover our collection of thrilling games with amazing rewards.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: <FiShield className="w-8 h-8" />,
      title: "Fair Play",
      description: "Provably fair system ensures transparent and honest gameplay.",
      ...
      <div className="container mx-auto px-4 py-12 mt-[8vh]">
        ...
        >
          <motion.h1 
            ...
            transition={{ duration: 0.8 }}
          >
            Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-gradient-x">BeatABack</span>
          </motion.h1>
          ...
          >
            Experience the ultimate gaming platform with cutting-edge games, fair play, and instant rewards.
          </motion.p>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center mb-12">
              <h2 className="text-4xl font-bold mb-4 md:mb-0">
                Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Games</span>
              </h2>
              <Link 
                to="/games" 
                className="flex items-center text-blue-400 hover:text-blue-300 transition-colors group"
              >
                <span className="mr-2 group-hover:mr-3 transition-all">Explore All Games</span>
        ...
        >
          {featureCards.map((feature, index) => (
            ...
            >
              ...
              <div className={`absolute bottom-0 left-0 h-1 w-0 group-hover:w-full transition-all duration-500 bg-gradient-to-r ${feature.color}`}></div>
            </motion.div>
          ))}
        </motion.section>
        ...
        {!user && (
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join our community of gamers and start winning today. No experience needed!
            </p>
